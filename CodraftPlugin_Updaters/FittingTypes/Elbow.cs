...
namespace CodraftPlugin_Updaters.FittingTypes
{
    public class Elbow : BaseFitting
    {
        ...
        public Elbow(FamilyInstance elbow, Document doc, string databaseMapPath, string textFilesMapPath, JObject parameterFile)
            : base(elbow, doc, databaseMapPath, textFilesMapPath, parameterFile)
        {
