...
namespace CodraftPlugin_Updaters.PipeAccessoriesTypes
{
    public class ThreeWayGlobeValve : BaseAccessory
    {
        ...
        public override bool? GetParams()
        {
            ...
            if (FileOperationsPipeAccessories.LookupThreeWayValve(Query, QueryCount, ConnectionString, out parametersList, parameterConfiguration))
            {
        ...
        {
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_1"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_2"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_3"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_4"]["revit"]).AsInteger());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_5"]["revit"]).AsInteger());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_6"]["revit"]).AsInteger());
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_7"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_8"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_9"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_10"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_11"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_12"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_13"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_14"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_15"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_16"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_17"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(Math.Round(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_18"]["revit"]).AsDouble(), 4));
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_19"]["revit"]).AsString());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_20"]["revit"]).AsString());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_21"]["revit"]).AsString());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_22"]["revit"]).AsString());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_23"]["revit"]).AsString());
            this.RevitParameters.Add(this.PipeAccessory.LookupParameter((string)parameterConfiguration["parameters"]["threewayGlobeValve"]["property_24"]["revit"]).AsString());
