...
namespace CodraftPlugin_Updaters.PipeAccessoriesTypes
{
    public class StraightValve : BaseAccessory
    {
        ...
        public override void CreateAccessory()
        {
            ...
            this.PipeAccessory.LookupParameter("Hoogte_operator").Set((double)this.DatabaseParameters[1]);
            this.PipeAccessory.LookupParameter("Hendel_lengte").Set((double)this.DatabaseParameters[2]);
            this.PipeAccessory.LookupParameter("Motor_lengte").Set((double)this.DatabaseParameters[3]);
            ...
            this.PipeAccessory.LookupParameter("Motor_hoogte").Set((double)this.DatabaseParameters[11]);
            this.PipeAccessory.LookupParameter("Motor_breedte").Set((double)this.DatabaseParameters[12]);
            this.PipeAccessory.LookupParameter("COD_Fabrikant").Set((string)this.DatabaseParameters[13]);
            this.PipeAccessory.LookupParameter("COD_Type").Set((string)this.DatabaseParameters[14]);
            this.PipeAccessory.LookupParameter("COD_Materiaal").Set((string)this.DatabaseParameters[15]);
            this.PipeAccessory.LookupParameter("COD_Productcode").Set((string)this.DatabaseParameters[16]);
            this.PipeAccessory.LookupParameter("COD_Omschrijving").Set((string)this.DatabaseParameters[17]);
            this.PipeAccessory.LookupParameter("COD_Beschikbaar").Set((string)this.DatabaseParameters[18]);
        }
