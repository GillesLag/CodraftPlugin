...
namespace CodraftPlugin_Updaters.PipeAccessoriesTypes
{
    public class StraightValve : BaseAccessory
    {
        ...
        public void CreateAccessory()
        {
            ...
            this.PipeAccessory.LookupParameter("Uiteinde_1_type").Set((int)this.Parameters[4]);
            this.PipeAccessory.LookupParameter("Uiteinde_2_type").Set((int)this.Parameters[5]);
