...
namespace CodraftPlugin_Library
{
    public static class ElementSettings
    {
        ...
        /// <param name="fi"></param>
        public static void SetCodraftParametersTee(List<object> parameters, FamilyInstance fi, Newtonsoft.Json.Linq.JObject file)
        {
        ...
        public static void SetCodraftParametersTransition(List<object> parameters, FamilyInstance fi, bool switchNds, int excentrischOrConcentrisch, Newtonsoft.Json.Linq.JObject file)
        {
            if (!switchNds)
            {
        ...
        public static void SetCodraftParametersTap(List<object> parameters, FamilyInstance fi, Newtonsoft.Json.Linq.JObject file)
        {
        ...
        public static void TapDoesNotExist(FamilyInstance fi, Newtonsoft.Json.Linq.JObject file)
        {
        ...
        public static void TeeDoesNotExist(FamilyInstance fi, Newtonsoft.Json.Linq.JObject file)
        {
        ...
        public static void TransitionDoesNotExist(FamilyInstance fi, Newtonsoft.Json.Linq.JObject file)
        {
