<<<<<<< HEAD:CodraftPlugin/CodraftPlugin_DAL/FileOperations.cs
...
namespace CodraftPlugin_DAL
{
    public static class FileOperations
    {
        ...
        /// <returns>true if there is at least one record in the database, otherwise false</returns>
        public static bool LookupElbow(string query, string queryCount, string connectionString, out List<object> paramList, Newtonsoft.Json.Linq.JObject file)
        {
        ...
        public static bool LookupTee(string query, string queryCount, string connectionString, out List<object> paramList, Newtonsoft.Json.Linq.JObject file)
        {
            paramList = new List<object>();
            bool hasMultipleRows;
        ...
        public static bool LookupTransistion(string query, string queryCount, string connectionString, out List<object> paramList, Newtonsoft.Json.Linq.JObject file)
        {
            paramList = new List<object>();
            bool hasMultipleRows;
        ...
        /// <returns></returns>
        public static bool LookupTap(string query, string queryCount, string connectionString, double maxDiameter, out List<object> paramList, Newtonsoft.Json.Linq.JObject file)
        {
            paramList = new List<object>();
            bool hasMultipleRows;
...
>>>>>>> d6e0d3104505cbbcc016557f6e71b292ef6d28c5:CodraftPlugin_DAL/FileOperations.cs
